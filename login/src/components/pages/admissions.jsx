  ...
  return (
      ...
      <div className="admission-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            CHECK <Link to="/sidebarmanag/schedule" style={{ color: '#007bff' }}>SCHEDULE PAGE</Link> IF TIME SLOT IS AVAILABLE FOR THIS INSTRUCTOR
          </label>
          <br/>
            ...
            <div className="modal-content">
              <button
                ...
                onClick={() => {
                  ...
                  window.location.href = '/sidebarmanag/schedule';
                }}
              >
                ×
              </button>
