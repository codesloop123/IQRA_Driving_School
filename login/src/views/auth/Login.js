...
import iqra from "../../assets/img/iqra.png";
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div className="flex justify-center items-center py-4 gap-2">
                  <img src={iqra} height={50} width={50} alt="project-icon" />
                  <p className="font-bold">IQRA Driving School</p>
                </div>
                <div className="text-blueGray-400 text-center mb-3 py-3 font-bold">
                  <h2>Sign In</h2>
                </div>
                <form onSubmit={(e) => handleSubmit(e)}>
                  ...
                  {/* <div className="flex justify-center text-center mt-6">
                    ...
                    >
                      {isSigninLoading ? (
                        <svg
                          aria-hidden="true"
                          className="inline w-2 h-2 text-center text-gray animate-spin dark:text-lime fill-light"
                          viewBox="0 0 100 101"
                          fill="none"
                  ...
                  <div className="flex justify-center text-center mt-6">
                    <button
                      disabled={isSigninLoading}
                      className="flex items-center justify-center bg-blueGray-800 text-center text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                      type="submit"
                    >
                      {isSigninLoading ? (
                        <svg
